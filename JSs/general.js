...
function setSize(){
    ...
    style_width('subject','86');
    style_width('subjectFP','86');
    ...
    style_top('firstPageInf4','15');
    style_top('firstPageInf5','25.5');
    style_top('firstPageInf6','30.5');
    style_top('firstPageInf7','38.5');
    style_top('firstPageInf8','55.5');
    style_top('firstPageInf9','60.5');
    ...
    style_margin_left('generalSelect','3');
    ...
    style_margin_top('DisplayTarjomeh1','2.5');
    style_margin_top('partishen-general','0');
    style_margin_top('generalSelect','1.8');
    ...
    style_margin_right('generalSelect','3');
    ...
    style_margin_bottom('generalSelect','1.8');
...
function onePageCode() {
    ...
    if(valueS<625 && 0<valueS){
        ...
        if (nesbatScreen == '1.778'){
            proses.push(['endPage4'])
        }else if (nesbatScreen=='1.333'){
            proses.push(['endPage3'])        
        }
...
function sorehCode() {
    ...
    if (inf.infStartSoreh[valueS][1]==0 && inf.infStartSoreh[valueS+1][1]==0){
        for(var i = 0; i <inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]; ++i){
            chinesh(inf.infStartSoreh[valueS][0]+i)
        }
    }else if (inf.infStartSoreh[valueS][1]==0 && inf.infStartSoreh[valueS+1][1]>0 && inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]==1){
        for(var i = 0; i <inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]; ++i){
            chinesh(inf.infStartSoreh[valueS][0]+i)
        }
        chinesh2(inf.infStartSoreh[valueS+1][0],0)
    }else if (inf.infStartSoreh[valueS][1]==2 && inf.infStartSoreh[valueS][0]==624){
        chinesh2(inf.infStartSoreh[valueS][0],2)
    }else if (inf.infStartSoreh[valueS][1]==0 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0] && inf.infStartSoreh[valueS+1][1]==1){
        chinesh2(inf.infStartSoreh[valueS][0],0)
    }else if (inf.infStartSoreh[valueS][1]==1 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0] && inf.infStartSoreh[valueS+1][1]==2){
        chinesh2(inf.infStartSoreh[valueS][0],1)
    }else if (inf.infStartSoreh[valueS][1]==2 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0]-1 && inf.infStartSoreh[valueS+1][1]==0){
        chinesh2(inf.infStartSoreh[valueS][0],2)
    }else if (inf.infStartSoreh[valueS][1]==1 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0]-1 && inf.infStartSoreh[valueS+1][1]==0){
        chinesh2(inf.infStartSoreh[valueS][0],1)
    }else if (inf.infStartSoreh[valueS][1]==1 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0]-1 && inf.infStartSoreh[valueS+1][1]==1){
        chinesh2(inf.infStartSoreh[valueS][0],1)
        chinesh2(inf.infStartSoreh[valueS+1][0],0)
    }else if (inf.infStartSoreh[valueS][1]==2 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0]-1 && inf.infStartSoreh[valueS+1][1]==1){
        chinesh2(inf.infStartSoreh[valueS][0],2)
        chinesh2(inf.infStartSoreh[valueS+1][0],0)
    }else if (inf.infStartSoreh[valueS][1]==1 && inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]>=2){
        chinesh2(inf.infStartSoreh[valueS][0],1)
        for(var i = 1; i <inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]; ++i){
            chinesh(inf.infStartSoreh[valueS][0]+i)
        }
    }else if (inf.infStartSoreh[valueS][1]==2 && inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]>=2){
        chinesh2(inf.infStartSoreh[valueS][0]+i,2)
        for(var i = 1; i <inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]; ++i){
            chinesh(inf.infStartSoreh[valueS][0]+i)
        }
    } 
    ...
    if(inf.infStartSoreh[valueS][0]==624){
        nameSorehString=`<br>صفحه ${inf.infStartSoreh[valueS][0]} مصحف قرآن مبارک<br>شامل ${numSlide-2} اسلاید`;
    }else if(inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0]){
        nameSorehString=`<br>صفحه ${inf.infStartSoreh[valueS][0]} مصحف قرآن مبارک<br>شامل ${numSlide-2} اسلاید`;
    }else if(inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0]-1){
        nameSorehString=`<br>صفحه ${inf.infStartSoreh[valueS][0]} مصحف قرآن مبارک<br>شامل ${numSlide-2} اسلاید`;
    }else{
        nameSorehString=`<br>صفحه ${inf.infStartSoreh[valueS][0]} تا صفحه ${inf.infStartSoreh[valueS+1][0]-1} مصحف قرآن مبارک<br>شامل ${numSlide-2} اسلاید`;
    }

    if (nesbatScreen == '1.778'){
        document.getElementById('firstPage_numPage').innerHTML=`سوره مبارکه ${inf.infPage[inf.infStartSoreh[valueS][0]-1][inf.infPage[inf.infStartSoreh[valueS][0]-1].length-1][inf.infStartSoreh[valueS][1]]}`;
        document.getElementById('firstPage_Subject').innerHTML='<br>'+nameSorehString;
        document.getElementById('firstPage_Subject2').innerHTML=``;
        document.getElementById('firstPage_Subject3').innerHTML=``;
        document.getElementById('firstPage').style.display='block';
    }else if (nesbatScreen=='1.333'){
        document.getElementById('firstPage_numPage3').innerHTML=`سوره مبارکه ${inf.infPage[inf.infStartSoreh[valueS][0]-1][inf.infPage[inf.infStartSoreh[valueS][0]-1].length-1][inf.infStartSoreh[valueS][1]]}`;
        document.getElementById('firstPage_Subject9').innerHTML='';
    ...
    if(document.getElementById('tarjomeh_or_no').checked){
        if (inf.infStartSoreh[valueS][1]==0 && inf.infStartSoreh[valueS+1][1]==0){
            chineshTarjomeh(inf.infStartSoreh[valueS][0],1)
            for(var i = 1; i <inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]; ++i){
                chineshTarjomeh(inf.infStartSoreh[valueS][0]+i,0)
            }
        }else if (inf.infStartSoreh[valueS][1]==0 && inf.infStartSoreh[valueS+1][1]>0 && inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]==1){
            chineshTarjomeh(inf.infStartSoreh[valueS][0],1)
            for(var i = 1; i <inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]; ++i){
            ...
            chineshTarjomeh2(inf.infStartSoreh[valueS+1][0],0,0)
        }else if (inf.infStartSoreh[valueS][1]==2 && inf.infStartSoreh[valueS][0]==624){
            chineshTarjomeh2(inf.infStartSoreh[valueS][0],2,0)
        }else if (inf.infStartSoreh[valueS][1]==0 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0] && inf.infStartSoreh[valueS+1][1]==1){
            chineshTarjomeh2(inf.infStartSoreh[valueS][0],0,0)
        }else if (inf.infStartSoreh[valueS][1]==1 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0] && inf.infStartSoreh[valueS+1][1]==2){
            chineshTarjomeh2(inf.infStartSoreh[valueS][0],1,0)
        }else if (inf.infStartSoreh[valueS][1]==2 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0]-1 && inf.infStartSoreh[valueS+1][1]==0){
            chineshTarjomeh2(inf.infStartSoreh[valueS][0],2,0)
        }else if (inf.infStartSoreh[valueS][1]==1 && inf.infStartSoreh[valueS][0]==inf.infStartSoreh[valueS+1][0]-1 && inf.infStartSoreh[valueS+1][1]==0){
            chineshTarjomeh2(inf.infStartSoreh[valueS][0],1,0)
            ...
            chineshTarjomeh2(inf.infStartSoreh[valueS][0]+i,2,0)
            for(var i = 1; i <inf.infStartSoreh[valueS+1][0]-inf.infStartSoreh[valueS][0]; ++i){
                chineshTarjomeh(inf.infStartSoreh[valueS][0]+i,0)
            }
        } 
...
function chineshTarjomeh(numPage,xx){
    ...
    for(var n=0; n<num_line_tarjome_page.length; n+=1){
        ...
        while (x < num_line_tarjome_page[n].length){
            var inArray = [];
            var tarjome_inArray="";
            if(num_line_tarjome_page[n][x]=='به نام خدای بخشندۀ مهربان' || num_line_tarjome_page[n][x]=='1. به نام خدای بخشندۀ مهربان'){
                tarjome_inArray = `سوره ${inf.infPage[value][inf.infPage[value].length-1][n]}<br>` + num_line_tarjome_page[n][x];
            }else if(n==0 && x == 0 && xx==1 && value!=0){
                tarjome_inArray = "به نام خدای بخشندۀ مهربان" + "<br>" + num_line_tarjome_page[n][x];
            }else{
                tarjome_inArray = num_line_tarjome_page[n][x];
            }
            ++x;
            num_length_tarjome=200;
            if (nesbatScreen == '1.778'){
            ...
            while (num_length_tarjome>tarjome_inArray.length){
                if(num_line_tarjome_page[n][x]==undefined){
                    ...
                    if(num_line_tarjome_page[n][x][0]>=0 && num_line_tarjome_page[n][x][0]<=9){
                        tarjome_inArray = tarjome_inArray + "<br>" + num_line_tarjome_page[n][x];
                    }else{
                        tarjome_inArray = tarjome_inArray + " " + num_line_tarjome_page[n][x];
                    }
                    ++x;
                }
...
function chinesh2(numPage,num) {
    ...
    var j=0;
    while(j<inf.matn[value][num].length){
        if (inf.matn[value][num][j]== '老  بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ' || inf.matn[value][num][j]== 'بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ' || (value==189 && j ==0)){
            if (num_line == '4'){
                if(inf.matn[value][num].length==4){
                    if(nesbatScreen=='1.778'){
                        tarkib2.push('partFP42');
                    }else{
                        tarkib2.push('partFP422');
                    }
                    tarkib2.push(inf.infPage[value][num][inf.infPage[value][num].length-1])
                    tarkib2.push(`${inf.infSoreh[value][num][0]} آیه`);
                    tarkib2.push(inf.infPage[value][num][0]);
                    tarkib2.push(`جزء ${inf.infSoreh[value][num][1]}`);
                    tarkib2.push(inf.matn[value][num][j]);
                    tarkib2.push(inf.matn[value][num][j+1]);
                    tarkib2.push(inf.tarjome[value][num][j]);
                    tarkib2.push(inf.tarjome[value][num][j+1]);
                    j+=2;
                    proses.push(tarkib2)
                    tarkib2 = []
                }else{
                    ...
                    tarkib2.push(inf.matn[value][num][j]);
                    tarkib2.push(inf.matn[value][num][j+1]);
                    tarkib2.push(inf.matn[value][num][j+2]);
                    tarkib2.push(inf.tarjome[value][num][j]);
                    tarkib2.push(inf.tarjome[value][num][j+1]);
                    tarkib2.push(inf.tarjome[value][num][j+2]);
                    j+=3;
                    proses.push(tarkib2)
                    tarkib2 = []
                }
            ...
            if (num_line == '4'){
                if (inf.matn[value][num].length-j >= 6){
                    if(nesbatScreen=='1.778'){
                        tarkib2.push('part44');
                    }else{
                        tarkib2.push('part442');
                    ...
                    tarkib2.push(inf.matn[value][num][j+1]);
                    tarkib2.push(inf.matn[value][num][j+2]);
                    tarkib2.push(inf.matn[value][num][j+3]);
                    tarkib2.push(inf.tarjome[value][num][j]);
                    tarkib2.push(inf.tarjome[value][num][j+1]);
                    tarkib2.push(inf.tarjome[value][num][j+2]);
                    tarkib2.push(inf.tarjome[value][num][j+3]);
                    j+=4;
                    proses.push(tarkib2)
                    tarkib2 = []
                }else if (inf.matn[value][num].length-j == 5){
                    if(nesbatScreen=='1.778'){
                        tarkib2.push('part43');
                    }else{
                        tarkib2.push('part432');
                    ...
                    proses.push(tarkib2)
                    tarkib2 = []
                }else if (inf.matn[value][num].length-j == 4){
                    if(nesbatScreen=='1.778'){
                        tarkib2.push('part44');
                    }else{
                        tarkib2.push('part442');
                    ...
                    proses.push(tarkib2)
                    tarkib2 = []
                }else if (inf.matn[value][num].length-j == 3){
                    if(nesbatScreen=='1.778'){
                        tarkib2.push('part43');
                    }else{
                        tarkib2.push('part432');
                    ...
                    proses.push(tarkib2)
                    tarkib2 = []
                }else if (inf.matn[value][num].length-j == 2){
                    if(nesbatScreen=='1.778'){
                        tarkib2.push('part42');
                    }else{
                        tarkib2.push('part422');
                ...
                if (inf.matn[value][num].length-j !=1 ){
                    if(nesbatScreen=='1.778'){
                        tarkib2.push('part22');
                    }else{
                        tarkib2.push('part222');
...
function chineshTarjomeh2(numPage,n,xx){
    var value = numPage-1
    var num_line = localStorage.getItem('number_line');
    var nesbatScreen = localStorage.getItem('nesbat');
...
function nextOrPrevious(i) {
    ...
    if (proses[valueNumberPage][0] == 'nameGod2' || proses[valueNumberPage][0] == 'endPage2' || proses[valueNumberPage][0] == 'nameGod' || proses[valueNumberPage][0] == 'endPage' || proses[valueNumberPage][0] == 'endPage3' || proses[valueNumberPage][0] == 'endPage4'){
        ...
        if(proses[valueNumberPage][0] == 'part44'){
            ...
            document.getElementById('nameSoreh41').innerHTML = "سورةُ" + proses[valueNumberPage][3];
            ...
            document.getElementById('nameSoreh42').innerHTML = "سورةُ" +  proses[valueNumberPage][3];
            ...
            document.getElementById('nameSoreh43').innerHTML = "سورةُ" +  proses[valueNumberPage][3];
            ...
            document.getElementById('nameSoreh412').innerHTML = "سورةُ" +  proses[valueNumberPage][3];
            ...
            document.getElementById('nameSoreh422').innerHTML = "سورةُ" +  proses[valueNumberPage][3];
            ...
            document.getElementById('nameSoreh432').innerHTML = "سورةُ" +  proses[valueNumberPage][3];
...
// function hidden_cursor(){
//     // Advanced Auto-Hide Cursor Script
//     (function() {
//         'use strict';
...
//         let statusElement = document.getElementById('cursor-status');
...
//             statusElement.textContent = `وضعیت موس: ${status}`;
//             statusElement.style.background = status === 'فعال' ? 
...
//             cursorTimeout = setTimeout(hideCursor, CONFIG.delay);
//             log('Timer reset');
//         }
...
//                 'contextmenu', 'drag', 'dragstart',
//                 'dragend', 'dragover', 'dragenter',
//                 'dragleave', 'drop'
//             ];
...
//             body.style.cursor = '';
//             body.style.transition = 'cursor 0.3s ease';
...
//             log('Auto-hide cursor initialized');
//             log(`Hide delay: ${CONFIG.delay}ms`);
//         }
...
//                 resetTimer();
//                 log(`Delay updated to: ${newDelay}ms`);
//             },
...
//                 log('Cursor controller disabled');
//             }
//         };
